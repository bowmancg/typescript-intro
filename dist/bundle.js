...
(function (App) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, peopleNum) {
            const newProject = new App.Project(Math.random().toString(), title, description, peopleNum, App.ProjectStatus.Active);
...
(function (App) {
    class ProjectInput extends App.Component {
        ...
        gatherUserInput() {
            ...
            if (!App.validating(titleValidatable) ||
                !App.validating(descriptionValidatable) ||
                !App.validating(peopleValidatable)) {
                alert("Invalid Input");
                return;
            }
            else {
